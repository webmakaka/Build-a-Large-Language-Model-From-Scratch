...
<ol>
  ...
  <li>Предварительное обучение на неразмеченных данных (Предварительно обучим модель GPT-2)</li>
  <li>Тонкая настройка по классификации (Загрузим предварительно обученные веса из OpenAI)</li>
